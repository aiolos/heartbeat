    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql(
            'CREATE TABLE heartbeats (
                ...
                INDEX IDX_E40BD8961FB8D185 (host_id), 
                PRIMARY KEY(id)
        ...
        $this->addSql(
            'CREATE TABLE hosts (
                ...
                ttl VARCHAR(255) NOT NULL, PRIMARY KEY(id)
             ) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB'
        );
        $this->addSql(
            'ALTER TABLE heartbeats ADD CONSTRAINT FK_E40BD8961FB8D185 FOREIGN KEY (host_id) REFERENCES hosts (id)'
        );
    }
